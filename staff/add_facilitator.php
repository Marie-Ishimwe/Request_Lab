...
<body>
    <div class="login-dark" id='hero'>
        ...
        // Communicating that all fields aint filled
            if (isset($_GET["error"])){
                ...
                // Communicating that username is taken
                    ...
                    echo '<div class="toast" style="position:absolute; min-height: 40px; background-color:red; width:auto; margin-left:70%; text-align:center; padding:10px; margin-top:1%;">
                    <div style="top: 0; right: 0;">
                        <div class="toast-header">
                            <button type="button" class="ml-2 mb-1 close" onclick="closeToast()">
                                <span aria-hidden="true">&times;</span>
        ...
        ?>
        <form method="post" action="../includes/add_facilitator.php">
            ...
            <div class="form-group">
                <button class="btn btn-primary btn-block" type="submit" name="creating-facilitator">Add facilitator</button>
            </div>
        </form>
    </div>
