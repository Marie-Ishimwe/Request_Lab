    ...
    <div class="login-dark" action="" id="hero">
        ...
        <form method="post">
            <div class="illustration">
                <h3><a href="st_dashboard.php">Administrative request</a></h3>
            </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE administrative_request SET comment = ? WHERE request_id = ?";
    ...
    if ($stmt->execute()) {
        ...
        header("location:admin_response.php?request_id=" . $requestId);
